...
public class Testing {
      ...
      public static void main(String[] args) throws IOException  {
        ...
        /*  pleas paset the file path in your computer*/
         File file = new File("C:\\Users\\User\\Desktop\\program\\Hostpital\\admins\\HeadOFHosybital.txt");
...
while(check != 1){
     System.out.println("enter the id of the dector you want to serach for ");
       int ID = read.nextInt();
   for (Services s : list_of_Services ){
